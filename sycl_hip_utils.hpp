...
inline status_t create_and_set_tensor_descriptor(
        ...
        int ndims, int *dims, int *strides) {
            std::cout << "sycl_hip_utils.hpp " << __LINE__ << " dims[0]= " << dims[0] <<std::endl;
            std::cout << "sycl_hip_utils.hpp " << __LINE__ << " dims[1]= " << dims[1] <<std::endl;
            std::cout << "sycl_hip_utils.hpp " << __LINE__ << " dims[2]= " << dims[2] <<std::endl;
            std::cout << "sycl_hip_utils.hpp " << __LINE__ << " dims[3]= " << dims[3] <<std::endl;
            std::cout << "sycl_hip_utils.hpp " << __LINE__ << " dims[4]= " << dims[4] <<std::endl;
...
/*inline status_t create_and_set_weight_descriptor(
        miopenTensorDescriptor_t *tensor_desc, miopenDataType_t data_type,
        miopenTensorLayout_t tensorLayout, int *dims, int ndims) {

    CHECK(MIOPEN_EXECUTE_FUNC_S(miopenCreateTensorDescriptor, tensor_desc));
    CHECK(MIOPEN_EXECUTE_FUNC_S(miopenSetNdTensorDescriptorWithLayout,
     *tensor_desc, data_type, tensorLayout, dims, ndims));
